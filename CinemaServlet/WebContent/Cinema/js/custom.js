                ...
                $('.sits__place').click(function (e) {
                    ...
                    if(! $(e.target).hasClass('sits-state--your')){
                        ...
                        if (! $(this).hasClass('sits-state--not') ) {
                            ...
                            $('.checked-place').prepend('<span id="choosen" class="choosen-place '+place+'" title='+place+'>'+ place +'</span>'); 
                        ...
                        var text=$(".checked-result").text();
                        //var c=$('#choosen').attr("title");
                       // alert(c);
                       ...
                       // $('#ahrefid').attr('href','buyticket?m_id='+m_id+'&s_time='+s_time+'&s_seat='+place+'&s_price='+text+''); 
                       
                        //$('#ahrefid').attr("href")+="&parm="; 
                    }
