                ...
                <div class="movie movie--preview movie--full release">
                     <div class="col-sm-3 col-md-2 col-lg-2">
                            <div class="movie__images">
                                <img alt='' src="images/movie/${mlist.l_img}">
                            </div>
                    ...
                    <div class="col-sm-9 col-md-10 col-lg-10 movie__about">
                            <a href='movie-page-full.html' class="movie__title link--huge">${mlist.m_name}</a>

                            <p class="movie__time">${mlist.m_mtime } min</p>

                            <p class="movie__option"><strong>制片国家/地区: </strong><a href="#">${mlist.m_country }</a></p>
                            <p class="movie__option"><strong>Category: </strong><a href="#">Comady</a></p>
                            <p class="movie__option"><strong>上映时间: </strong>${ mlist.m_time}</p>
                            <p class="movie__option"><strong>导演: </strong><a href="#">${mlist.m_detail }</a></p>
                            <p class="movie__option"><strong>演员: </strong><a href="#">${mlist.m_actor }</a>
                            <p class="movie__option"><strong>下荧时间: </strong><a href="#">${mlist.m_canceltime }</a></p>

                            <div class="movie__btns">
                                <a href="moviePage?m_id=${mlist.m_id }" class="btn btn-md btn--warning">book a ticket <span class="hidden-sm">for this movie</span></a>
